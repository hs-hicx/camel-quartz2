 ...
 * @version 
 */
public class Quartz2Message extends DefaultMessage {
    private final JobExecutionContext jobExecutionContext;

    public Quartz2Message(Exchange exchange, JobExecutionContext jobExecutionContext) {
    ...
    protected void populateInitialHeaders(Map<String, Object> map) {
        ...
        if (jobExecutionContext != null) {
            ...
            map.put("triggerName", trigger.getJobKey().getName());
            map.put("triggerGroup", trigger.getJobKey().getGroup());
        }
    }
}
